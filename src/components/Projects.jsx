              ...
              <div className="grid md:grid-cols-[1.1fr,1fr]">
                ...
                <div className="p-6 md:p-8">
                  <div className="flex items-baseline justify-between flex-wrap gap-2">
                    ...
                    <span className="font-mono text-xs text-navy-light shrink-0">{proj.period}</span>
                  </div>
                  ...
                  <p className="font-mono text-xs uppercase tracking-wide text-navy-light mt-6 mb-2">Results</p>
                  ...
                  <div className="flex gap-5 mt-6">
                    {proj.links.map((l) => (
                      <a key={l.label} href={l.url} className="font-mono text-xs uppercase tracking-wide text-navy-light hover:underline">
                        {l.label} →
                      </a>
                    ))}
                  </div>
